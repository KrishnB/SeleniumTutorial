  ...
  Scenario Outline:
    ...
    Examples:
    |First_Name|Last_Name|Gender |Date_of_Birth |Father_Name|Mother_Name|School       |Class  |Section|Roll_No        |Student_Address|Phone_Number|Email              |Insurance_ID|Blood_Group|
    |Arun      |Kumars   |Male   |05/07/2005    |Sreedharan |Manjula    |little Hearts|2      |A      |AS10056        |303,Kphb,Hyd   |9515101914  |1919arunk@gmail.com|ABC         |A+  |


    Scenario Outline:
      Given User <user_type> is on registration page
      When user registers a student with details <Student_Details>
      Then new student should be registered

      Examples:
      |user_type         |    Student_Details        |
      | frontDesk        |      ValidDetails         |
      | frontDesk        |      InvalidDetails       |